    ...
    ?> 
		...
		<section class="slider">
			<div class="hero-slider">
				<!-- Start Single Slider -->
                <?php foreach ($slider_content as $sliders => $slider) : ?>
				<div class="single-slider" style="background-image:url('<?php echo $slider['background']; ?>')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									...
									<div class="button">
										<a href="#" class="btn"> <?php echo $slider['button_1']; ?> </a>
										<a href="#" class="btn primary"> <?php echo $slider['button_2']; ?> </a>
									</div>
								</div>
							</div>
						</div>
        ...
        $schedule_content = [
            ...
            [
                ...
                "title" => "Opening Hours",
                "description" => "Monday - Fridayp8.00-20.00<br>
                                  Saturday9.00-18.30 <br>
                                  Monday - Thusday9.00-15.00",
                "button" => "LEARN MORE",
            ],
		...
		<section class="schedule">
			<div class="container">
				<div class="schedule-inner">
					<div class="row">
                        <?php foreach ($schedule_content as $content) : ?>
							...
							<div class="single-schedule first">
								<div class="inner">
									...
									<div class="single-content">
										<span><?php echo $content['subtitle']; ?></span>
										<h4><?php echo $content['title']; ?></h4>
										<p><?php echo $content['description']; ?></p>
										<a href="#"><?php echo $content['button']; ?><i class="fa fa-long-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
